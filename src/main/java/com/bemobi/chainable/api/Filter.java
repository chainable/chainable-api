 ...
 *
 * @version $Id: Filter.java 1499551 2013-07-03 20:45:37Z britter $
 */
public interface Filter<K, V, C extends Map<K, V>> extends Command<K, V, C> {

    /**
     * <p>Execute any warm up activities, such as adding attributes to the #Context that
