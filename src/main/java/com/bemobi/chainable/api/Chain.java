 ...
 *
 * @version $Id: Chain.java 1499551 2013-07-03 20:45:37Z britter $
 */
public interface Chain<K, V, C extends Map<K, V>> extends Command<K, V, C> {
     ...
     *  is <code>null</code>
     *
     * @return {@link State#FINISHED} if the processing of this context
     *  has been completed. Returns {@link State#CONTINUE} if the processing
     *  of this context should be delegated to a subsequent command in an 
     *  enclosing chain.
     */
    State execute(C context);
